...
class PostController extends Controller
{
    ...
    public function view($post_id){
        ...
        $comments = DB::table('users')
            ...
            ->select('users.name', 'comments.*') //select one user and everything from comments
...
//filter if the same person likes the post
