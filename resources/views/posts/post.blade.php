                ...
                <div class="panel-body">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ url('/addPost') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group{{ $errors->has('post_body') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <textarea id="email" class="form-control" name="post_body" rows= "7" value="{{ old('post_body') }}" required>
                                    </textarea>
                            ...
                            <div class="form-group{{ $errors->has('category_id') ? ' has-error' : '' }}">
                                <label for="password" class="col-md-4 control-label">Categories</label>
                            ...
                            <label for="post_image" class="col-md-4 control-label">Featured Images</label>
